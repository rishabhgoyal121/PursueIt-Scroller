...
var hcomp_labs_paths_el = d3.selectAll(
...
var intro_foreground_top_padding =
  -150 + (0.35 * Math.pow(window.innerHeight, 2)) / window.innerWidth;
function center_intro_foreground() {
  intro_foreground_top_padding =
    -150 + (0.35 * Math.pow(window.innerHeight, 2)) / window.innerWidth;
